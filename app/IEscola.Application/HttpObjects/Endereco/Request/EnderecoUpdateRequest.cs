...
namespace IEscola.Application.HttpObjects.Endereco.Request
{
    public class EnderecoUpdateRequest
    {
        ...
        [Range(1, int.MaxValue, ErrorMessage = "Endereço deve ser maior que 0")]
        ...
        [Range(1, int.MaxValue, ErrorMessage = "Bairro deve ser maior que 0")]
        ...
        [Range(1, int.MaxValue, ErrorMessage = "Cidade deve ser maior que 0")]
        public string Cidade { get; set; }

        [Required(ErrorMessage = "Estado não preenchido.")]
        [Range(1, int.MaxValue, ErrorMessage = "Estado deve ser maior que 0")]
